...
sub event_input_msg {
  ...
  dbg(4, "event_privmsg() wgl_process() translate returned: " .
         Dumper(\$result));
...
sub event_topic {
  ...
  print CLIENTCRAP "event_topic() not implemented. FIXME.";
  return;
}
...
Irssi::settings_add_str ("gtrans", "gtrans_topic_auto",          0);
